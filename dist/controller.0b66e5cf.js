...
var AddContactView = /*#__PURE__*/function () {
  function AddContactView() {
    ...
    _defineProperty(this, "modal", document.querySelector(".add-contact"));
    _defineProperty(this, "formContainer", document.querySelector(".add-contact form"));
    _defineProperty(this, "inputName", this.formContainer.querySelector(".name-input"));
    _defineProperty(this, "inputPhone", this.formContainer.querySelector(".phone-input"));
    _defineProperty(this, "inputEmail", this.formContainer.querySelector(".email-input"));
    _defineProperty(this, "addContactBtn", document.querySelector(".add-btn"));
...
var ContactContainerView = /*#__PURE__*/function () {
  function ContactContainerView() {
    ...
    _defineProperty(this, "container", document.querySelector(".list-container"));
  }
  _createClass(ContactContainerView, [{
    ...
    value: function pushContactIntoContainer(contact) {
      var html = this.generatCardContactHTML(contact);
    ...
    value: function generateHTMLString() {
      ...
      if (Array.isArray(data)) {
        data.forEach(function (contact) {
          html += _this2.generatCardContactHTML(contact);
        });
        return html;
      }
    }
  }, {
    key: "generatCardContactHTML",
    value: function generatCardContactHTML(contact) {
      return " <div class=\"card flex between\">\n            <div class=\"info flex column start\">\n              <span>".concat(contact.name, "</span>\n              <span>").concat(contact.phone, "</span>\n              <span>").concat(contact.email, "</span>\n            </div>\n            <button class=\"delete\" id=\"").concat(contact.id, "\"><i class=\"fa-solid fa-user-minus\"></i></button>\n        </div>");
    }
  }]);
...
var SearchView = /*#__PURE__*/function () {
  function SearchView() {
    ...
    _defineProperty(this, "inputQuery", document.querySelector(".search-input"));
  }
...
init();
},{"./model":"src/model.js","./Views/AddContactView":"src/Views/AddContactView.js","./Views/ContactContainerView":"src/Views/ContactContainerView.js","./Views/searchView":"src/Views/searchView.js"}],"../../../Users/dalvi/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../Users/dalvi/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/controller.js"], null)
